...
export default function DashboardPclPage() {
  return (
    <div className="space-y-5 pb-20 lg:pb-0">
      ...
      <nav className="fixed bottom-3 left-3 right-3 z-30 grid grid-cols-5 rounded-[1.4rem] border border-white/70 bg-white/90 p-2 shadow-2xl backdrop-blur-2xl dark:border-white/10 dark:bg-slate-950/85 lg:hidden">
        {([
